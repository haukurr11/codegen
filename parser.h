...
// Syncronizing sets
static const TokenCode programSync[] = {
	tc_EOF,
	tc_VAR,
	tc_FUNCTION,
	tc_PROCEDURE,
...
static const TokenCode identifierListSync[] = {
	tc_RPAREN,
	tc_COLON,
	tc_NONE
};
static const TokenCode subProgramHeadSync[] = {
	tc_FUNCTION,
	tc_PROCEDURE,
	tc_BEGIN,
	tc_VAR,
...
static const TokenCode declarationsSync[] = {
	tc_FUNCTION,
	tc_PROCEDURE,
	tc_BEGIN,
	tc_VAR,
...
static const TokenCode standardTypeSync[] = {
	tc_SEMICOL,
	tc_NONE
};
static const TokenCode argumentsSync[] = {
	tc_COLON,
	tc_SEMICOL,
	tc_NONE
};
static const TokenCode parameterListSync[] = {
	tc_RPAREN,
	tc_SEMICOL,
	tc_INTEGER,
	tc_REAL,
...
static const TokenCode compoundStatementSync[] = {
	tc_RPAREN,
	tc_COLON,
	tc_DOT,
	tc_SEMICOL,
...
static const TokenCode statementSync[] = {
	tc_SEMICOL,
	tc_BEGIN,
	tc_END,
	tc_ELSE,
...
static const TokenCode factorSync[] = {
	tc_SEMICOL,
	tc_BEGIN,
	tc_THEN,
	tc_DO,
...
private:
	...
	bool tokenCodeIn(TokenCode tc, const TokenCode list[]);	// Is the given tokencode in the list
	void recover(const TokenCode list[]);	// keep asking for tokens until token is found in the list
